...
Scenario Outline: Delete car(s) from database by car(s) to delete list
...
But we add first car into to delete list as <car_2>
But we add first car into to delete list as <car_4>

When delete cars from database using list of cars
Then the database shouldn't contains cars from list but should contains cars: <car_1> ||||| <car_3> 
